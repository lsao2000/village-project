...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<OtpProviderController>( create: (ctx) => OtpProviderController()),
        ChangeNotifierProvider<JoinedUserProvider>( create: (ctx) => JoinedUserProvider()),
        ChangeNotifierProvider<IghoumaneUserProvider>( create: (ctx) => IghoumaneUserProvider()),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
